...
local starttrigger = "You are mine now."
local starttrigger2 = "You... are next."
local starttrigger3 = "I see you..."
local teleport_trigger = "The end is upon you."

local L = mod:NewLocale("enUS", true)
if L then
	L.starttrigger = starttrigger
	...
	L.teleport_trigger = teleport_trigger
...
function mod:OnBossEnable()
	self:Yell("Engage", L["starttrigger"], L["starttrigger2"], L["starttrigger3"], starttrigger, starttrigger2, starttrigger3)
	self:Yell("Teleport", L["teleport_trigger"], teleport_trigger)

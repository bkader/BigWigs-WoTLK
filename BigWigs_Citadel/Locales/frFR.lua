...
if L then
	...
	L.dnd_bar = "Prochaine Mort et décomposition"
...
if L then
	...
	L.engage_trigger =
		"Grande nouvelle, mes amis ! Je crois que j'ai mis au point une peste qui va détruire toute vie sur Azeroth !"
...
if L then
	...
	L.iconprince_desc =
		"Place l'icône de raid principale sur le prince de sang actuellement surpuissant (nécessite d'être assistant ou mieux)."
...
if L then
	L.engage_trigger =
		"Des intrus se sont introduits dans le sanctuaire. Hâtez-vous d'achever le dragon vert ! Ne gardez que les os et les tendons, pour la réanimation !"
	...
	L.blazing_desc =
		"Délai de réapparition |cffff0000estimé|r des Squelettes flamboyants. Ce délai est sans doute imprécis, utilisez-le donc comme un repère."

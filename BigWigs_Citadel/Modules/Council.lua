...
mod.toggleOptions = {
	{72040, "ICON", "FLASHSHAKE"},
	72039,
	{72037, "SAY", "FLASHSHAKE", "WHISPER"},
	72999,
	70981,
	72052,
	{"iconprince", "ICON"},
	...
	if count == 3 then --3 bosses engaged
		...
		if guid then
			...
			if guid == 37970 or guid == 37972 or guid == 37973 then
				...
				self:Bar(72037, L["shock_bar"], random(14, 18), 72037)
				self:Berserk(600)
			else
				self:Disable()
			end

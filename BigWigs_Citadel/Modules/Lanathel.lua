...
function mod:OnEngage(diff)
	...
	self:Bar(71340, L["pact_bar"], 15, 71340)
	self:Bar(71265, L["shadow_bar"], 30.5, 71265)
end
...
do
	...
	local function pact()
		...
		mod:Voice(71340, -1, 18)
		mod:Voice(71340, 0, 25)
		mod:Bar(71340, L["pact_bar"], 30.5, 71340)
		scheduled = nil
	end
	function mod:Pact(player)
		if UnitIsUnit(player, "player") then
			self:Voice(71340, true)
...
function mod:AirPhase(player, spellId)
	...
	self:Bar(71772, L["phase1_bar"], 20, spellId)
